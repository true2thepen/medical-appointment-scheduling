...
(function (root, factory) {
  ...
  function ClockPicker(element, options) {
    ...
    // Convert to jQuery element if a native element was passed
    element = $(element);
    ...
    $('<button type="button" md-button class="btn-flat clockpicker-button" tabindex="' + (options.twelvehour? '3' : '1') + '">' + options.donetext + '</button>').click($.proxy(this.done, this)).appendTo(this.footer);
